...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')]  # Statické soubory v režimu vývoje

STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # Statické soubory v produkci
